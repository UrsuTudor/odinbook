...
ActiveRecord::Schema[7.2].define(version: 2024_12_10_103847) do
  ...
  create_table "users_followers_followees", id: false, force: :cascade do |t|
    t.bigint "follower_id"
    t.bigint "followee_id"
    t.index ["followee_id"], name: "index_users_followers_followees_on_followee_id"
    t.index ["follower_id"], name: "index_users_followers_followees_on_follower_id"
  end
